document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fungsi untuk mengatur kecepatan animasi running text berdasarkan scroll
    function adjustAnimationSpeed() {
        const scrollPosition = window.scrollY;
        const speed = Math.max(5, 20 - scrollPosition / 50); // Sesuaikan kecepatan berdasarkan scroll
        runningText.style.animationDuration = `${speed}s`;
    }
